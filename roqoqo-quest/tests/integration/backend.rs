...
fn test_insufficient_qubit_error1() {
    ...
    assert_eq!(
        e,
        RoqoqoBackendError::GenericError { msg: " Insufficient qubits in backend. Available qubits:`4`. Use of qubits with index: `6`. ".to_string() }
    )
}
...
fn test_insufficient_qubit_error2() {
    ...
    assert_eq!(
        e,
        RoqoqoBackendError::GenericError { msg: " Insufficient qubits in backend. Available qubits:`1`. Use of qubits with index: `4`. ".to_string() }
    )
}
