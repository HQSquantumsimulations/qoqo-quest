...
try:
    with open('../qoqo_quest/__version__.py') as f:
        lines = f.readlines()
...
htmlhelp_basename = 'qoqoquestdoc'
...
latex_documents = [
    (master_doc, 'qoqo_quest.tex', 'qoqo_quest Documentation',
...
man_pages = [
    (master_doc, 'qoqo_quest', 'qoqo_quest Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qoqo_quest', 'qoqo_quest Documentation',
     author, 'qoqo_quest', 'QuEST simulator backend for qoqo quantum computing toolkit.',
     'Miscellaneous'),
]
